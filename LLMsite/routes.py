...
def topic_popularity_difficulty(earliest_date,latest_date):
    ...
    tp_dif_mat= pd.DataFrame(0,columns=['Avg_answers','Perc_with_acc',"Med_hrs_to_first_answer","PD",'Avg_hrs_to_first_answer'],index=range(len(model.topic_sizes_)))
...
def fetch():
    ...
    avg_hours_to_first_answer=res_pop_dif[1]["Med_hrs_to_first_answer"].tolist()#res_pop_dif[1]["Avg_hrs_to_first_answer"].tolist()
    #print(avg_hours_to_first_answer)
